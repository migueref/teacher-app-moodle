 ...
 */
.controller('mmTeacherCtrl', function($scope, $mmCourses,$stateParams, $mmCoursesDelegate, $mmUtil, $mmEvents, $mmSite, $q,
    ...
    console.log("hola")
			/******Moodle********/
      // Obtener tareas pendientes por revisar por cursos
      $http({
        method: 'POST',
        url: 'https://www.cife.edu.mx/admin/application/Controllers/forumCtrl.php',
        data: {
          txt_funcion: "getPendingAssignCourse",
          idCourse: $scope.courseId,
        }
      })
