 ...
 */
.controller('mmForumsCtrl', function($scope, $mmCourses, $mmCoursesDelegate, $mmUtil, $mmEvents, $mmSite, $q,
  		...
  		return $sce.trustAsHtml(x);
			...
			/******Moodle********/
					...
					$http({
 	 		  		...
 	 		  		data: {
 	 		  			txt_funcion: "getForums",
              username:  $scope.siteinfo.username
 	 		  		}
 	 		  	})
 	 		  	.success(function(data){
 	 		  		 	$scope.mdl_forums=data;

						//	$scope.mdl_forums.created=timestamp = new Date($scope.mdl_forums.created).getTime()
							//console.log($scope.mdl_forums)
 	 		  	})
